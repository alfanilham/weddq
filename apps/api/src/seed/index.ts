  ...
  const templates = [
    {
      slug: "lumina",
      name: "Lumina",
      style: "Modern · Minimalis Luxe",
      category: "modern",
      priceIdr: 110000,
      badge: "Eksklusif",
      isFeatured: true,
      palette: "paper",
      description: "Minimalis mewah dengan ruang kosong yang lega, hairline emas, dan aksen aura yang berputar lembut.",
      features: ["Aksen aura beranimasi", "Scroll reveal halus", "Galeri tak terbatas", "Domain pribadi"],
    },
    {
      slug: "noctura",
      name: "Noctura",
      ...
      isFeatured: true,
      palette: "sepia",
      description: "Kanvas gelap elegan dengan nama mempelai berkilau emas, partikel mengambang, dan garis emas tipis.",
      features: ["Shimmer emas pada nama", "Partikel beranimasi", "Mode gelap penuh", "Domain pribadi"],
    },
    {
      slug: "sekar-kencana",
      name: "Sekar Kencana",
